...
class Dashboard extends CI_Controller {
	...
	public function newMember()
	{
		if($this->session->userdata('logged')){
			...
			$data['sub'] = $this->dashboard_model->getSubById($id);
			$data['account'] = $this->auth_model->getAccount($id);
			$this->load->view('adm_new_member_view', $data);
		} else {
			redirect('auth');
		}
	}
	...
	public function listMember()
	{
		if($this->session->userdata('logged')){
			...
			$data['sub'] = $this->dashboard_model->getSubById($id);
			$data['account'] = $this->auth_model->getAccount($id);
			$this->load->view('adm_member_view', $data);
		} else {
			redirect('auth');
		}
	}
	...
	public function profile()
	{
		if($this->session->userdata('logged')){
			...
			$data['sub'] = $this->dashboard_model->getSubById($id);
			$data['account'] = $this->auth_model->getAccount($id);
			$this->load->view('adm_profile_view', $data);
		} else {
			redirect('auth');
		}
	}
	...
	public function gallery()
	{
		if($this->session->userdata('logged')){
			...
			$data['sub'] = $this->dashboard_model->getSubById($id);
			$data['account'] = $this->auth_model->getAccount($id);
			$this->load->view('adm_gallery_view', $data);
		} else {
			redirect('auth');
		}
	...
	public function event()
	{
		if($this->session->userdata('logged')){
			...
			$this->load->view('adm_event_view', $data);
		} else {
			redirect('auth');
		}
	}
