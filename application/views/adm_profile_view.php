            ...
            <div class="col-lg-12 col-xs-12">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <a href="#" data-toggle="modal" id="editProfileBtn" data-target="#editProfile" class="btn btn-primary btn-block">Edit</a>
                </div>
                <!-- /.box-body -->
              </div>
              <!-- /.box -->
        ...
        <form action="<?php echo base_url('profile/editProfile');?>" id="form" class="form-horizontal" method="post" enctype="multipart/form-data">
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-xs-10">
                <input name="fullName" id="fullName" required placeholder="Full Name" class="form-control" type="text" value="<?php echo $sub->NAMA_SUB ;?>">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-xs-2">Acronym</label>
              <div class="col-xs-10">
                <input name="acronymName" id="acronymName" required placeholder="Acronym" class="form-control" type="text" value="<?php echo $sub->SINGKATAN_SUB ;?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-xs-2">Secondary Color</label>
              <div class="col-xs-10">
                <input type="text" required name="secondaryCol" id="secondaryCol" class="form-control my-colorpicker1" value="<?php echo $sub->SECONDARY_COLOR ;?>">
              </div>
            </div>
            <div class="form-group">
