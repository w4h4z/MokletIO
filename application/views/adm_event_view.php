...
foreach ($event as $data) {
  ...
  <div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <h3 class="modal-title">Edit tes</h3>
  </div>
  <div class="modal-body form">
  <form action="'.base_url().'event/editEvent/'.$data->ID_EVENT.'"class="form-horizontal" method="post" enctype="multipart/form-data">
  <div class="form-body">
  <div class="form-group">
  <label class="control-label col-md-3">Event Title</label>
  <div class="col-md-9">
  ...
  <label class="control-label col-md-3">Banner Photo</label>
  <div class="col-md-9">
  <input name="photoBanner" class="form-control" type="file">
  </div>
  </div>
  <div class="form-group">
  <label class="control-label col-md-3">Poster Photo</label>
  <div class="col-md-9">
  <input name="photoPoster" class="form-control" type="file">
  </div>
  </div>
  </div>
  </div>
